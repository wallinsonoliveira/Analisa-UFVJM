...
export default function ProcessDashboardCopy() {
          ...
          <div className="flex-1 flex items-center w-full max-w-7xl mx-auto mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
              <div className="flex flex-col justify-center">
                ...
                <h2 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">Painel do Escritório de Processos (Cópia)</h2>
                <p className="text-xl text-white/90 mb-16">Indicadores referentes ao Escritório de Processos - Versão Duplicada</p>
    ...
    <div className="min-h-screen bg-white font-sans text-slate-800">
      <header className="bg-white px-8 py-6 flex justify-between items-center border-b border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Painel de Mapeamento de Processos (Cópia)</h1>
      ...
      <main className="max-w-[1400px] mx-auto px-8 py-8 space-y-8">
        <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-xl p-4 flex items-center gap-3 text-[#15803d]">
          ...
          <span className="font-medium text-sm">Base de dados carregada com sucesso</span>
        </div>
        ...
        {activeTab === 'glossario' && (
          <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm space-y-6">
            ...
            <p className="text-slate-600 mb-8">
              Abaixo estão os termos técnicos utilizados neste painel.
            </p>
